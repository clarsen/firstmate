...
family_for_basename() {
  case "$1" in
    ...
    fm-claude-bg-move-registry-live-e2e.test.sh|\
    fm-claude-hook-renewal-live-e2e.test.sh|\
...
tests/fm-claude-bg-move-registry-live-e2e.test.sh 45
tests/fm-claude-hook-renewal-live-e2e.test.sh 45
...
tests/fm-spawn-home-pool-isolation.test.sh 31911
tests/fm-spawn-pool-base-freshen.test.sh 62249
tests/fm-spawn-project-setup.test.sh 17321
