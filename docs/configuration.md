...
FM_CLAUDE_AUTOARM_RENEW_AFTER=43200   # seconds a quiet Stop-owned Claude cycle runs before one silent renewal turn; keep at most half the registered auto-arm hook timeout (docs/watcher-continuity.md)
