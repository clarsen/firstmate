...
# onward, so this test fails loudly if the physical-path project comparison
# in bin/fm-spawn.sh ever regresses.
...
run_spawn_symlink_case() {  # <label> <physical|logical>
  ...
  # fm-spawn.sh's own physical project path resolves, including any symlink layers
